...
def generate_radar_blueprint(blueprint_library):
    ...
    radar_blueprint.set_atribute('horizontal_fov', str(45))
    radar_blueprint.set_atribute('vertical_fov',str(35))
    radar_blueprint.set_atribute('points_per_second', str(20000))
    radar_blueprint.set_atribute('range', str(25))
